...
function GridLayoutApp() {
	...
	useEffect(() => {
		console.log("GridLayoutApp 俺挂载啦~~~");
		return () => {
			console.log("GridLayoutApp 俺被卸载啦 呜呜呜~~~");
		};
	}, []);
	...
	return (
		<div>
			{/* 新增元素 */}
			<button className="droppable-element" draggable={true} unselectable="on" onDragStart={onDragStart}>
				拖拽添加
			</button>
			{/* 拖拽区域 */}
			<GridLayout className="layout" cols={4} width={1200} rowHeight={80} layout={layoutArr} onDrop={onDrop} isDroppable={true}>
				{layoutArr.map(item => (
